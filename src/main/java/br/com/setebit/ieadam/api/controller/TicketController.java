...
import br.com.setebit.ieadam.api.dto.Summary;
...
import br.com.setebit.ieadam.api.security.enums.StatusEnum;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> findById(@PathVariable("id") String id) {
		Response<Ticket> response = new Response<Ticket>();
		Optional<Ticket> ticketOptional = ticketService.findById(Long.parseLong(id));
	...
	public ResponseEntity<Response<Ticket>> changeStatus(
		...
		try {
			...
			Optional<Ticket> ticketCurrentOptional = ticketService.findById(Long.parseLong(id));
			Ticket ticketCurrent = ticketCurrentOptional.get();
